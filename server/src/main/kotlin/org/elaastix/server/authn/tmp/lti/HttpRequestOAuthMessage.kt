/*
 * https://github.com/elaastic/elaastic-questions-server/blob/29dc9a8a09e9063c0252007f61486f9d11a20eab/server/src/main/kotlin/org/elaastic/auth/lti/oauth/HttpRequestOAuthMessage.kt
	...
	companion object {
		...
		fun getParameters(request: HttpServletRequest): List<OAuth.Parameter> {
			...
			request.getHeaders("Authorization").iterator().forEach {
				for (parameter in decodeAuthorization(it)) {
