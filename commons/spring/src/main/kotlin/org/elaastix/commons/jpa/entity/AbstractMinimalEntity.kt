...
/**
 * Abstract class holding core properties shared by **all** entities.
 * Deals with the implementation of best current practice, specifically around [equals] and [hashCode].
 *
 * In general, entities should inherit [AbstractEntity] instead. This class is relevant for immutable records that
 * do not need versioning nor an update timestamp.
 *
 * @see AbstractEntity
 */
@MappedSuperclass
@EntityListeners(AuditingEntityListener::class)
abstract class AbstractMinimalEntity {
	/**
	...
	final override fun equals(other: Any?): Boolean {
		...
		return id == (other as AbstractMinimalEntity).id
	}
