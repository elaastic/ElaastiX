...
- The contribution MUST NOT be substantially or fully AI generated.
...
- The use of AI assistance MUST be disclosed.
  ...
  - When the commit messages are AI generated, the *PR description* MUST mention it.
  ...
  - The specific tool used and/or the specific model MUST NOT be part of the git history.
    ...
    - As such this information is more appropriate within the PR description instead.
  - Direct mention of specific agentic software or models SHOULD be generally avoided.
...
[Linux Kernel policy guide on AI coding assistants]: https://docs.kernel.org/process/coding-assistants.html
