...
[group('fmt')]
[doc('Runs detekt on all Gradle projects.')]
[arg('fix', long='fix', value='-Pdetekt.fix', help='Fix auto-fixable issues')]
[no-exit-message]
detekt fix='': (_gradle fix ':detekt' 'detektMain' 'detektTest' 'detektIntegrationTest')
...
[group('misc')]
[doc('Runs a gradle command. OS-independent helper for running gradlew')]
[no-exit-message]
@gradle *ARGS: (_gradle ARGS)
